...
public class ActionComboPaciente implements FocusListener,ActionListener{
		...
		public ActionComboPaciente( JComboBox comboNombre,JComboBox comboID, Facade facade,
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			controlador.rellenarDatos(panel, facade.obtenerPaciente(String.valueOf(item.getId())));
			}
		}
