...
public class ParaUI extends UI {
	...
	public ParaUI() {
		...
		ActionComboPaciente actionComboCitaPrimariaPaciente = new ActionComboPaciente(getComboBoxIdCitaPrimaria(), getComboBoxNombreCitaPrimaria(), facade, controladorPanelDatosPersonales, getPanelDatosPersonalesBajaDoctor());
		...
		ActionComboDoctor actionComboCitaPrimariaDoctor= new ActionComboDoctor(getComboBoxIdCiaPrimariaDoctor(), getComboBoxNombreCiaPrimariaDoctor(), facade, controladorPanelDatosPersonales, getPanelDatosPersonalesBajaDoctor());
		...
		citaPrimario.panelPedirCitaPaciente.getPanelMensajeCita().getBtnAplicr().addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				//facade.guardarCita(citaMV);
				//facade.guardarDoctor(controladorPanelDatosPersonales.obtenerDatos(getPanelDatosPesonalesAltaDoctor()));
				//	controladorMensaje.mostrarMensajes(citaPrimario.ge "Alta correctamente");
