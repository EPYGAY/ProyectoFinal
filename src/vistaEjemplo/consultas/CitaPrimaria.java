...
public class CitaPrimaria extends JPanel {
	...
	public CitaPrimaria() {
		...
		JLabel lblCitaAtencionPrimaria = new JLabel("Cita Atencion Primaria");
						...
						.addGroup(groupLayout.createSequentialGroup()
							...
							.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
								.addGroup(groupLayout.createSequentialGroup()
									...
									.addGap(27)
									.addComponent(button_20, GroupLayout.PREFERRED_SIZE, 120, GroupLayout.PREFERRED_SIZE))
		...
		colorOriginal=button.getBackground();
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				switchColor((JButton)e.getSource());
			}
		});
	...
	private void switchColor(JButton source) {
		
		Color miColor=Color.RED;
		if(source.getBackground().equals(miColor)) {
			miColor=colorOriginal;
		}
		source.setBackground(miColor);
	}
