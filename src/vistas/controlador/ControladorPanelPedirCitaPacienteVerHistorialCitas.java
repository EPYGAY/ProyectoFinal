...
public class ControladorPanelPedirCitaPacienteVerHistorialCitas {
	...
	public void rellenarTablaCita(PanelVerHistorialPaciente panel, ArrayList<CitaMV> lista) {
		...
		panel.getTableVerHistorial().setModel(defaultTableModel);
