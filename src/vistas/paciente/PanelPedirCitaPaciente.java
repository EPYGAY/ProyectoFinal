...
private JComboBox comboBoxNombreDoctorCItaPaciente;
	...
	public PanelPedirCitaPaciente(boolean horarioMañana, boolean mañanastxt) {
		...
		panelMensajeCita.setBackground(new Color(240, 230, 140));
		
		panel_3 = new JPanel();
		panel_3.setBackground(new Color(244, 164, 96));
		Botonera botonera = new Botonera(100, 0);
			...
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
						...
						.addComponent(comboBoxIDDoctorCItaPaciente, GroupLayout.PREFERRED_SIZE, 71, GroupLayout.PREFERRED_SIZE))
					.addGap(0))
				.addGroup(groupLayout.createSequentialGroup()
					.addGap(37)
					.addComponent(panel, GroupLayout.DEFAULT_SIZE, 826, Short.MAX_VALUE)
					.addGap(18)
					.addComponent(comboBoxNombreDoctorCItaPaciente, GroupLayout.PREFERRED_SIZE, 271, GroupLayout.PREFERRED_SIZE)
					.addGap(1702))
		);
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						.addGroup(groupLayout.createSequentialGroup()
							...
							.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
								.addGroup(groupLayout.createSequentialGroup()
									.addGap(16)
									.addComponent(comboBoxIDDoctorCItaPaciente, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
									.addGap(42)
									.addComponent(panel_1, GroupLayout.PREFERRED_SIZE, 326, GroupLayout.PREFERRED_SIZE))
								.addGroup(groupLayout.createSequentialGroup()
									.addGap(379)
									.addComponent(panelMensajeCita, GroupLayout.PREFERRED_SIZE, 52, GroupLayout.PREFERRED_SIZE))))
						.addGroup(groupLayout.createSequentialGroup()
							.addGap(55)
							.addComponent(botonera, GroupLayout.PREFERRED_SIZE, 367, GroupLayout.PREFERRED_SIZE)))
					.addGap(102))
		);
